...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('sogoMaster/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/aos.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/jquery.timepicker.cs')}}s">
    <link rel="stylesheet" href="{{asset('sogoMaster/css/fancybox.min.css')}}">
    
    <link rel="stylesheet" href="{{asset('sogoMaster/fonts/ionicons/css/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('sogoMaster/fonts/fontawesome/css/font-awesome.min.css')}}">

    <!-- Theme Style -->
    <link rel="stylesheet" href="{{asset('sogoMaster/css/style.css')}}">
  </head>
  <body>
    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="hotel1">Sogo Hotel</a></div>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        <li class="active"><a href="hotel1">Home</a></li>
    ...
    <section class="site-hero overlay" style="background-image: url(sogoMaster/images/hero_4.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <script src="{{asset('sogoMaster/js/jquery-3.3.1.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/jquery-migrate-3.0.1.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/popper.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/jquery.stellar.min.js')}}"></script>
    <script src="{{asset('sogoMaster/js/jquery.fancybox.min.js')}}"></script>
    
    
    <script src="{{asset('sogoMaster/js/aos.js')}}"></script>
    
    <script src="{{asset('sogoMaster/js/bootstrap-datepicker.js')}}"></script> 
    <script src="{{asset('sogoMaster/js/jquery.timepicker.min.js')}}"></script> 

    

    <script src="{{asset('sogoMaster/js/main.js')}}"></script>
  </body>
</html>